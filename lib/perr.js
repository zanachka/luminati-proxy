...
const E = module.exports = {start_time: -1, enabled: true, zagent: true};
...
const perr_send = (id, info, opt)=>{
    ...
    const source = E.zagent ? 'cloud_pmgr' : 'lpm';
    opt = opt||{};
...
E.set_opt = opt=>
    Object.entries(opt||{}).forEach(([key, value])=>E[key]=value);
